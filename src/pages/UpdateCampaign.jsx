    ...
    const [form, setForm] = useState({
      ...
      <form onSubmit={handleSubmit} className="w-full mt-[65px] flex flex-col gap-[30px]">
        <div className="flex flex-wrap gap-[40px]">
          <FormField 
            labelName="Campaign ID *Can be found in the URL"
            placeholder="123"
            inputType="text"
            value={form.id}
        ...
        <div className="w-full flex justify-start items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]">
          ...
          <h4 className="font-epilogue font-bold text-[25px] text-white ml-[20px]">You will get 95% of the raised amount and 5% goes to the platform</h4>
        </div>

        <div className="flex flex-wrap gap-[40px]">
          <FormField 
            labelName="Goal *"
            placeholder="VTRU 0.50"
            inputType="text"
            value={form.target}
